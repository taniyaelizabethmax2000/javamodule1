...
public class Carfactory {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * System.out.println(jag.hashCode()); System.out.println(
		 * Integer.toHexString(jag.hashCode())); System.out.println(jag);
		 */
		 ...
		 */
		/*
		 * System.out.println(bmw.getColor()); System.out.println(bmw.getPrice());
		 * System.out.println(bmw.getBrand()); System.out.println(bmw.getModel());
		 */
		/*
