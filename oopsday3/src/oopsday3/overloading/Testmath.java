...
public class Testmath {
   ...
   result2 = math.add(10.25f,20.25f); //compile time polymorphism or early binding.compiler thinks when we give float values as method is there or not to assign values or not
