...
public class TestTreeMap {
	...
	public static void main(String[] args) {
		TreeMap<String,String> countryCurr = new TreeMap<>(); //for treemap sorted order will come
		
		//for arrays indexorder will come.map is key value pair
		//for trees it is sorted in ascending order
	...
	//countryCurr.put(null, null);//null pointer exception
